...
- **Baskı:** A4 210×297 mm, **tek sayfa** — yazdırma yüksekliği ölçüldü: **243 mm**, Safari'nin varsayılan kenar boşlukları + üst/alt bilgi satırları için **28 mm pay** kalıyor. Fotoğraflar **renkli** (`print-color-adjust: exact`). Ölçüm **794 px** (A4 genişliği) viewport'ta yapılır: masaüstü genişliğinde ölçmek yanıltıcı, kolonlar daralınca metin uzuyor. Safari'nin iletişim kutusunda **"Üst bilgileri ve alt bilgileri yazdır" işaretini kaldırmak** en temiz sayfayı verir (yoksa kenara URL/başlık basılır).
