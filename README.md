...
- **Okuma durumu**: bir habere tıklamak onu **okundu** işaretler; okunanlar solgunlaşır ve üstteki sayaç "N yeni" der. **Sadece yeni** düğmesi (`?yeni=1`) okunmuşları listeden düşürür — kaynak başına sınır **önce** uygulandığı için okudukça liste gerçekten kısalır, yerine havuzdan haber gelmez. **Okundu say** görünenleri, **Okumaları sıfırla** tüm geçmişi temizler. Kayıt tarayıcıda (`tel:okunan`), sunucuya gitmez; 120 günden eski kayıtlar kendiliğinden düşer.
