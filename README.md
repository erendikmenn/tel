...
- **Dizgi:** üst bant (3 kısa teaser) → **gotik künye** → künye şeridi (gün · tarih · sayı) → manşet + italik deck → **fotoğrafın SOLUNA ve SAĞINA iki ayrı haber** (flanker) → gerekçeli 3 kolon manşet gövdesi (ilk harf büyük) → 3 fotoğraflı haber + çerçeveli **Öne çıkanlar** sütunu → 4 kolon **kısa kısa** → sayfanın dibinde **kalın siyah kapanış çizgisi**. Alt bilgi metni (kaynaklar, tarih) **yok**; kaynak her haberin kendi etiketinde görünür.
