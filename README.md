...
- **Baskı:** A4 210×297 mm, **tek sayfa** ve **sayfa tamamen dolu**. Yazdırma görünümünde `.paper` yüksekliği **281 mm** (A4 − 2×7 mm kenar) sabitlenir; **kısa kısa** bloğu `flex: 1` ile artan yüksekliği emer, sığmayan satırlar `overflow: hidden` ile kırpılır — böylece sayfa altta boş kalmaz. Aday sayısı bu yüzden bol tutulur (`PAPER_BRIEFS = 60`). Fotoğraflar **renkli** (`print-color-adjust: exact`).
